                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <label for="project_code" class="col-form-label mr-1">Project Code</label><span
                                    class="text-danger">*</span>
                                <input type="text" class="form-control" id="project_code" name="project_code" value="<?php echo $row['project_code'] ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="date" class="form-control" id="expected_end_date" name="expected_end_date" value="<?php echo $row['expected_end_date'] ?>"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="reference_by" name="reference_by" value="<?php echo $row['reference_by'] ?>"
                                autocomplete="off" >
                        </div>
                        <div class="form-group ">
                            ...
                            <textarea type="text" class="form-control" id="project_location" name="project_location"
                                autocomplete="off" required><?php echo $row['project_location'] ?></textarea>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
