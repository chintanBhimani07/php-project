            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form id="edit_productivity_form">
                        <input type="hidden" class="form-control" id="productivity_id" name="productivity_id" value="<?php echo $prod['productivity_id'] ?>" autocomplete="off" required>
                        <div class="form-group">
                            <label for="productivity_subject" class="col-form-label mr-1">Subject</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="productivity_subject" name="productivity_subject" value="<?php echo $prod['productivity_subject'] ?>" autocomplete="off" autofocus required>
                        </div>
                        <div class="form-group">
                            <label for="productivity_date" class="col-form-label mr-1">Date</label><span class="text-danger">*</span>
                            <input type="date" class="form-control" id="productivity_date" name="productivity_date" value="<?php echo $prod['productivity_date'] ?>" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="start_time" class="col-form-label mr-1">Start Time</label><span class="text-danger">*</span>
                            <input type="time" class="form-control" id="start_time" name="start_time" value="<?php echo $prod['start_time'] ?>" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="end_time" class="col-form-label mr-1">End Time</label><span class="text-danger">*</span>
                            <input type="time" class="form-control" id="end_time" name="end_time" value="<?php echo $prod['end_time'] ?>" autocomplete="off" required>
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('#edit_productivity_form').submit(function(e) {
            e.preventDefault();
            $.ajax({
