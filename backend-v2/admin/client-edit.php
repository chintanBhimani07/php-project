    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="./index.php?page=client-dashboard" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-list fa-sm text-white mr-2"></i>Client</a>
        </div>
                    ...
                    <div class="card-body">
                        <form id="edit_client_form">
                            <input type="hidden" class="form-control" id="client_id" name="client_id"
                                value="<?php echo $row['client_id'] ?>" autocomplete="off">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="client_first_name" class="col-form-label mr-1">First Name</label><span
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="client_contact" name="client_contact"
                                        value="<?php echo $row['client_contact'] ?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="client_address" class="col-form-label mr-1">Resident Address</label>
                                <textarea type="text" class="form-control" id="client_address" name="client_address"
                                    autocomplete="off"><?php echo $row['client_address'] ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <a href="./index.php?page=client-dashboard"
                                        class="btn btn-warning btn-user btn-block text-dark">Back to Client List</a>
                                </div>
                            </div>
                        </form>
                    </div>
