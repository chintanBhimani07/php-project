            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form id="new_client_form">
                        <input type="hidden" class="form-control" id="project_id" name="project_id" value="<?php echo $projectId ?>" autocomplete="off" required>
                        <input type="hidden" class="form-control" id="task_id" name="task_id" value="<?php echo $taskId ?>" autocomplete="off" required>
                        <input type="hidden" class="form-control" id="user_id" name="user_id" value="<?php echo $_SESSION['login_user_id'] ?>" autocomplete="off" required>
                        <div class="form-group">
                            <label for="productivity_subject" class="col-form-label mr-1">Subject</label><span class="text-danger">*</span>
                            <input type="text" class="form-control" id="productivity_subject" name="productivity_subject" autocomplete="off" autofocus required>
                        </div>
                        <div class="form-group">
                            <label for="productivity_date" class="col-form-label mr-1">Date</label><span class="text-danger">*</span>
                            <input type="date" class="form-control" id="productivity_date" name="productivity_date" autocomplete="off" required>
                        </div>
                        <div class="form-group">
