                ...
                <div class="card-body">
                    <form id="new_project_form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="project_name" name="project_name" autocomplete="off" autofocus required>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="project_code" name="project_code" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" id="nature_of_project" name="nature_of_project" required>
