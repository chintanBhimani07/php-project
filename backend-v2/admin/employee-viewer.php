                                ...
                                <div class="col-lg-4 text-center d-flex align-items-center justify-content-center">
                                    <?php
                                        if($row['emp_profile_pic']){?>
                                            <img src="assets/uploads/<?php echo $row['emp_profile_pic']; ?>" alt="Profile" width="200" height="200">
                                        <?php }else{ ?>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 my-2">
                                                    <span class="font-weight-bold"><?php echo ucwords($row['emp_first_name'] . " " . $row['emp_last_name']) ?></span>
                                                </div>
                                                <div class="col-lg-3 my-2">
                                                    <span class="mr-2 d-none d-lg-inline text-gray-500">Email Address:</span>
                                                </div>
                                                <div class="col-lg-9 my-2">
                                                    <span class="font-weight-bold"><?php echo $row['emp_email'] ?></span>
                                                </div>
                                                <div class="col-lg-3 my-2">
                                                    <span class="mr-2 d-none d-lg-inline text-gray-500">Contact No:</span>
                                                </div>
                                                <div class="col-lg-9 my-2">
                                                    <span class="font-weight-bold"><?php echo $row['emp_mob'] ?></span>
                                                </div>
                                                <div class="col-lg-3 my-2">
                                                    <span class="mr-2 d-none d-lg-inline text-gray-500">Department:</span>
                                                </div>
                                                <div class="col-lg-9 my-2">
                                                    <span class="font-weight-bold"><?php echo ucwords($row['emp_department']) ?></span>
                                                </div>
                                                <div class="col-lg-3 my-2">
                                                    <span class="mr-2 d-none d-lg-inline text-gray-500">Designation:</span>
                                                </div>
                                                <div class="col-lg-9 my-2">
                                                    <span class="font-weight-bold"><?php echo ucwords($row['emp_designation']) ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php echo ucwords($row['emp_gender']) ?></span>
                            </div>
                            <div class="col-lg-2 my-2">
                                <span class="mr-2 d-none d-lg-inline text-gray-500">Date Of Birth:</span>
                            </div>
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php echo $row['emp_dob'] ?></span>
                            </div>
                            <div class="col-lg-2 my-2">
                            ...
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php echo ucwords($row['emp_hod_name']) ?></span>
                            </div>
                            <div class="col-lg-2 my-2">
                                <span class="mr-2 d-none d-lg-inline text-gray-500">Joining Date:</span>
                            </div>
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php echo ucwords($row['emp_joining_date']) ?></span>
                            </div>
                            <div class="col-lg-2 my-2">
                            ...
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php
                                    if ($row['emp_confirmation_date'] != '0000-00-00') {
                                        echo ucwords($row['emp_confirmation_date']);
                                    } else {
                                        echo '-';
                                    }
                               ?></span>
                            ...
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php
                                    if ($row['emp_confirmation_date'] != '0000-00-00') {
                                        echo ucwords($row['emp_leaving_date']);
                                    } else {
                                        echo '-';
                                    }
                               ?></span>
                            ...
                            <div class="col-lg-10 my-2">
                                <span class="font-weight-bold"><?php echo $row['emp_working_hours'] . " " . "Hours" ?></span>
                            </div>
                        </div>
                    </div>
                </div>
